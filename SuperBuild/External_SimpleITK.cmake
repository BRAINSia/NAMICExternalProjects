...
if(NOT ${CMAKE_PROJECT_NAME}_USE_SYSTEM_${proj})
  ...
  ExternalProject_add(SimpleITK
    ...
    CMAKE_CACHE_ARGS
      ...
      -DBUILD_SHARED_LIBS:BOOL=${${PRIMARY_PROJECT_NAME}_USE_SimpleITK_SHARED}
      -DBUILD_EXAMPLES:BOOL=OFF
      -DSimpleITK_PYTHON_THREADS:BOOL=ON
      -DSimpleITK_INSTALL_ARCHIVE_DIR:PATH=${${PRIMARY_PROJECT_NAME}_INSTALL_LIB_DIR}
      -DSimpleITK_INSTALL_LIBRARY_DIR:PATH=${${PRIMARY_PROJECT_NAME}_INSTALL_LIB_DIR}
